...
class System {
public:
    bool metropolisStepImportance   (double GibbsValue, bool interaction, std::vector<double> &X, std::vector<double> a_bias, std::vector<double> b_bias, std::vector<std::vector<double>> w);
    bool metropolisStepBruteForce   (double GibbsValue, bool interaction, std::vector<double> &X, std::vector<double> a_bias, std::vector<double> b_bias, std::vector<std::vector<double> > w);
    void runMetropolisSteps         (std::string method, int cycle, std::vector<double>&Gradient, int numberOfMetropolisSteps, bool interaction, std::vector<double> X, std::vector<double> a_bias, std::vector<double> b_bias, std::vector<std::vector<double> > w);
    ...
    void printOut                   (int cycle, int totalNumberOfCycles);
    ...
    bool   GibbsSampling                (std::vector<double> &X, std::vector<double> a_bias, std::vector<double> b_bias, std::vector<std::vector<double> > w);
