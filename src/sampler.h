...
public:
    ...
    void sample(double GibbsValue, bool acceptedStep, bool interaction, std::vector<double> X, std::vector<double> a_bias, std::vector<double> b_bias, std::vector<std::vector<double>> w);
