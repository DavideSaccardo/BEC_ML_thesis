...
# -*- coding: utf-8 -*-
"""
Created on Sat Jun 23 23:11:11 2018
...
s=np.asarray(s)
plot1=plt.figure();
plt.plot(s,np.log10(z2),label='L=0.01')
#plot2=
plt.plot(s,np.log10(z1),label='L=0.1')
#plot3=
plt.plot(s,np.log10(z3),label='L=0.5')
#plot4=
plt.plot(s,np.log10(z4),label='L=1.0')
#plot5=
plt.plot(s,np.log10(z5),label='L=2.0')
plt.title('$\sigma$ evolution for various BFM step lengths')
