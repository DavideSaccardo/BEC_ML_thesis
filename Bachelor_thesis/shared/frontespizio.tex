...
\usepackage{amsthm, siunitx}					%Calls AMS theorem environment
...
%\usepackage{subfloat}									%verbatim-like environment
\usepackage[version=0.96]{pgf}			%PGF/TikZ is a tandem of languages for producing vector graphics from a 
%\usepackage{tikz}						%geometric/algebraic description.
%\usetikzlibrary{arrows,shapes,snakes,
%		       automata,backgrounds,
%		       petri,topaths} \usepackage{circuitikz}					%To use diverse features from tikz		
